  ...
  const notifications = [
    {
      ...
      message:
        "Kontiki Park & Resort has been successfully added to the system.",
      date: "May 30th, 2025",
      time: "2:15pm",
      type: "success",
      read: false,
    ...
    },
    {
      ...
      message:
        "James M. Bracket published 'A Trip to Brass Island' - 245 views so far.",
      date: "May 29th, 2025",
      time: "4:22pm",
      type: "info",
      read: true,
    },
    {
      ...
      message:
        "Scheduled maintenance on June 1st, 2025 from 2:00am - 4:00am GMT.",
      date: "May 29th, 2025",
      time: "9:45am",
      type: "info",
      read: true,
    },
    {
      ...
      message:
        "Unusual high traffic detected on Cape Coast Castle page - 1,250 visitors in the last hour.",
      date: "May 28th, 2025",
      time: "6:30pm",
      type: "warning",
      read: false,
    },
    {
      ...
      message:
        "Sarah K. Williams submitted 'Exploring Hidden Gems of Cape Coast' for review.",
      date: "May 28th, 2025",
      time: "3:18pm",
      type: "action",
      read: true,
    },
    {
      ...
      message:
        "25 new users registered today. Consider reviewing onboarding process.",
      date: "May 28th, 2025",
      time: "10:15am",
      type: "info",
      read: true,
    },
    {
      ...
      message:
        "Request to remove 'Old Conference Center' from listings - requires admin approval.",
      date: "May 27th, 2025",
      time: "8:40pm",
      type: "error",
      read: false,
    },
    {
      ...
      message:
        "Your weekly performance report is ready. Total page views: 12,450 (+15% from last week).",
      date: "May 27th, 2025",
      time: "7:00am",
      type: "success",
      read: true,
    },
    {
      ...
      message:
        "Automated database backup completed successfully at 3:00am GMT.",
      date: "May 26th, 2025",
      time: "3:05am",
      type: "success",
      read: true,
    },
    {
      ...
      message:
        "Advanced search filters are now available for tourist attractions.",
      date: "May 25th, 2025",
      time: "11:20am",
      type: "info",
      read: true,
    },
    {
      ...
      message:
        "Failed to upload gallery images for Elmina Beach Resort. Please retry.",
      date: "May 25th, 2025",
      time: "9:33am",
      type: "error",
      read: false,
    },
    {
      ...
      message:
        "New 5-star review submitted for Labadi Beach Hotel by verified traveler.",
      date: "May 24th, 2025",
      time: "5:47pm",
      type: "success",
      read: true,
    },
    {
      ...
      message:
        "Third-party integration approaching rate limit. Consider upgrading plan.",
      date: "May 24th, 2025",
      time: "2:15pm",
      type: "warning",
      read: true,
    },
    {
      ...
      message:
        "Blog post flagged for review: 'Controversial Views on Local Tourism'.",
      date: "May 23rd, 2025",
      time: "7:22pm",
      type: "warning",
      read: false,
    },
    {
      ...
      message:
        "Average server response time improved by 23% after recent optimizations.",
      date: "May 23rd, 2025",
      time: "1:10pm",
      type: "success",
      read: true,
    },
    {
      ...
      message:
        "Tourism newsletter delivered to 5,847 subscribers with 32% open rate.",
      date: "May 22nd, 2025",
      time: "8:00am",
      type: "info",
      read: true,
    ...
    },
    {
      ...
      message:
        "Tourism board meeting scheduled for tomorrow at 10:00am in Conference Room A.",
      date: "May 21st, 2025",
      time: "4:30pm",
      type: "info",
      read: true,
    },
    {
      ...
      message:
        "Tourist attraction data export completed. Download link expires in 7 days.",
      date: "May 20th, 2025",
      time: "6:15am",
      type: "success",
      read: true,
    },
    {
      ...
      message:
        "Anonymous feedback: 'Love the new mobile interface! Much easier to navigate.'",
      date: "May 19th, 2025",
      time: "3:28pm",
      type: "info",
      read: true,
    },
    {
      ...
      message:
        "Update operating hours for 12 venues for summer season starting June 1st.",
      date: "May 19th, 2025",
      time: "9:00am",
      type: "action",
      read: false,
    },
    {
      ...
      message:
        "Ghana Tourism Authority interested in collaboration. Contact details in admin panel.",
      date: "May 18th, 2025",
      time: "12:45pm",
      type: "info",
      read: true,
    },
    {
      ...
      message:
        "Image storage 85% full. Consider upgrading storage plan or archiving old content.",
      date: "May 17th, 2025",
      time: "7:20am",
      type: "warning",
      read: false,
    },
    {
      ...
      message:
        "New mobile app version 2.1.3 released with improved map functionality.",
      date: "May 16th, 2025",
      time: "10:30am",
      type: "info",
      read: true,
    ...
    },
    {
      ...
      message:
        "Congratulations! The platform reached 50,000 total unique visitors this month.",
      date: "May 14th, 2025",
      time: "1:15pm",
      type: "success",
      read: true,
    },
    {
      ...
      message:
        "Backup verification failed for May 13th backup. Manual check required.",
      date: "May 13th, 2025",
      time: "8:45pm",
      type: "error",
      read: false,
    },
    {
      ...
      message:
        "Instagram posts automatically synced. 8 new posts featuring local attractions.",
      date: "May 12th, 2025",
      time: "11:00am",
      type: "success",
      read: true,
...
export const generateUserData = () => {
  const users = [
    ...
    },
    {
      ...
      email: "nanayaw.owusu@outlook.com",
      phone: "+233 244987654",
      location: "Sunyani",
      lastLogin: "8:30am",
    },
    ...
    },
    {
      ...
      email: "emmanuel.appiah@yahoo.com",
      phone: "+233 209876543",
      location: "Koforidua",
      lastLogin: "1:25pm",
    },
    ...
    {
      id: 23,
      name: "Richmond Quarshie",
      avatar: "https://randomuser.me/api/portraits/men/12.jpg",
      email: "richmond.quarshie@outlook.com",
      phone: "+233 245678901",
      location: "Elmina",
      lastLogin: "11:40am",
    },
    ...
    },
    {
      ...
      email: "benjamin.tetteh@outlook.com",
      phone: "+233 559876543",
      location: "Aflao",
      lastLogin: "12:48pm",
    },
    ...
    {
      id: 31,
      name: "Elizabeth Okyere",
      avatar: "https://randomuser.me/api/portraits/women/16.jpg",
      email: "elizabeth.okyere@yahoo.com",
      phone: "+233 241234567",
      location: "Ashanti Mampong",
      lastLogin: "7:20am",
    },
    {
      id: 32,
    ...
    },
    {
      ...
      email: "oliver.anderson@hotmail.com",
    ...
    },
    {
      ...
      email: "adjoa.sarpong@outlook.com",
      phone: "+233 503456789",
      location: "Techiman",
      lastLogin: "11:55am",
    },
    ...
    {
      id: 37,
      name: "Francisca Amoah",
      avatar: "https://randomuser.me/api/portraits/women/19.jpg",
      email: "francisca.amoah@yahoo.com",
      phone: "+233 247890123",
      location: "Prestea",
      lastLogin: "6:11pm",
    },
    ...
    },
    {
      ...
      email: "catherine.dubois@outlook.com",
      phone: "+1 514-555-7890",
      location: "Montreal",
      lastLogin: "5:16pm",
    },
  ];
